               ...
               <div className="grid grid-cols-4 gap-2">
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     size="small"
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[0] = { ...newBands[0], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.0.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.0.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[1] = { ...newBands[1], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.1.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.1.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[2] = { ...newBands[2], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.2.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.2.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[3] = { ...newBands[3], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.3.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.3.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[4] = { ...newBands[4], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.4.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.4.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[5] = { ...newBands[5], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.5.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.5.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[6] = { ...newBands[6], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.6.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.6.gain' : null)}
                   />
                 </div>
                 ...
                 <div className="text-center">
                   <HardwareKnob
                     ...
                     onChange={(value) => {
                       const newBands = [...audioEffects.eq.bands];
                       newBands[7] = { ...newBands[7], gain: value };
                       onUpdateEffectSettings('eq', { ...audioEffects.eq, bands: newBands });
                     }}
                     onKnobClick={handleKnobClick}
                     isEditing={editingKnob === 'eq.bands.7.gain'}
                     onEditingChange={(editing) => setEditingKnob(editing ? 'eq.bands.7.gain' : null)}
                   />
                 </div>
               </div>
            )}
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-yellow-200">Spatial Enhancement</p>
                  </div>
                </div>
              </div>
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                ...
                {manualAdjustments.has('stereoWidener') && (
                  <div className="flex items-center space-x-1">
                    <div className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></div>
                    <span className="text-yellow-400 text-xs">Modified</span>
                  </div>
