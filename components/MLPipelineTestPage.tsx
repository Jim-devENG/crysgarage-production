    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Checking ML Pipeline status...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Genre-Specific Processing</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Tier-Based Quality</h3>
            <p className="text-gray-600 text-sm">
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <div className="text-gray-600 font-mono">http://localhost:8000</div>
            </div>
          </div>
        </div>
