# Clean VPS Reset and Deploy Script
param(
...
Write-Host "Starting VPS Reset and Deploy..." -ForegroundColor Cyan

# Step 1: Clean VPS
Write-Host "`nCleaning VPS..." -ForegroundColor Yellow
ssh $SSH_OPTS $VPS_USER@$VPS_HOST "rm -rf /var/www/html/*; rm -rf /var/www/html/api/*; rm -rf /var/www/html/ruby/*; systemctl stop nginx"
...
ssh $SSH_OPTS $VPS_USER@$VPS_HOST "cd /var/www/html/api; unzip -o /tmp/backend.zip; rm -f /tmp/backend.zip; chown -R nginx:nginx /var/www/html/; chmod -R 755 /var/www/html/"

Remove-Item $backendTar -Force

# Step 4: Start Services
Write-Host "`nStarting Services..." -ForegroundColor Yellow
ssh $SSH_OPTS $VPS_USER@$VPS_HOST "systemctl start php8.2-fpm; systemctl start nginx"
