        ...
        {tiers.map((tier) => (
            <Card 
              ...
              className={`
                ...
                ${tier.id === 'free' 
                  ? 'border-blue-500 bg-gradient-to-b from-blue-500/10 to-blue-500/5 hover:border-blue-400' 
                  : tier.id === 'professional'
                  ? 'border-green-500 bg-gradient-to-b from-green-500/10 to-green-500/5 hover:border-green-400'
                  : 'border-red-500 bg-gradient-to-b from-red-500/10 to-red-500/5 hover:border-red-400'
                }
                ${tier.popular 
