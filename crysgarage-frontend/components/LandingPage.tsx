  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-crys-charcoal/30 relative py-20">
        <div className="container mx-auto px-8 sm:px-8 lg:px-12 max-w-[1100px]">
          <motion.div 
      ...
      <section className="bg-gradient-to-r from-crys-gold/10 via-crys-gold/5 to-crys-gold/10 relative overflow-hidden pt-16 pb-16">
        ...
        <div className="container mx-auto px-8 sm:px-8 lg:px-12 text-center relative z-10 max-w-[1100px]">
          <motion.div 
