...
export function LandingPage({ onGetStarted, onTryAnalyzer, onTryNormalizer, onGoToStudio }: LandingPageProps) {
            ...
            >
              ...
              >
                ...
                >
                  <Button 
                    size="lg"
                    onClick={onGoToStudio || onGetStarted}
              ...
              >
                <div className="bg-audio-panel-bg/50 border border-crys-graphite hover:border-crys-gold/50 rounded-xl p-8 w-full h-32 flex items-center justify-center transition-all duration-300 backdrop-blur-sm">
                  <ImageWithFallback
                    src={partner.logo}
                    alt={partner.alt}
                    className="w-full h-full max-w-full max-h-24 object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0"
                  />
                </div>
              </motion.div>
            ))}
