      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-gradient-to-r from-crys-gold/20 to-orange-500/20 rounded-lg p-6 border border-crys-gold/30 text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">Questions about this Privacy Policy?</p>
            <a href="mailto:privacy@crysgarage.studio" className="inline-block bg-crys-gold hover:bg-orange-500 text-black font-semibold px-6 py-3 rounded-lg transition-colors">Email privacy@crysgarage.studio</a>
          </section>
        </div>
      </div>
    </div>
