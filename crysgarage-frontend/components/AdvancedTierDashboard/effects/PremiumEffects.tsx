  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {/* G-Precision EQ - Enhanced with HardwareKnob */}
        ...
        {/* G-Mastering Compressor - Enhanced */}
        <div className="md:col-span-1 lg:col-span-1">
        ...
        {/* G-Widener - Enhanced with HardwareKnob */}
        ...
        {/* G-Digital Tape - Enhanced with HardwareKnob */}
        ...
        {/* G-Multi-Band - Enhanced with HardwareKnob */}
