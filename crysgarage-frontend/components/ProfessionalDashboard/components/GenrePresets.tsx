...
// Vibrant African-inspired gradient function for genre colors
const getGenreGradient = (genreId: string): string => {
  const colorMap: Record<string, string> = {
    ...
    'hip-life': 'from-red-500 to-red-700',
    azonto: 'from-orange-500 to-orange-700',
    'naija pop': 'from-yellow-500 to-yellow-700',
    'bongo flava': 'from-yellow-600 to-yellow-800',
    
    // South African genres - Cool, electric colors
    amapiano: 'from-green-600 to-green-800',
    kwaito: 'from-green-500 to-green-700',
    gqom: 'from-blue-600 to-blue-800',
    'shangaan electro': 'from-blue-500 to-blue-700',
    kwela: 'from-indigo-500 to-indigo-700',
    
    // Central/East African genres - Rich, deep colors
    kuduro: 'from-indigo-600 to-indigo-800',
    ndombolo: 'from-purple-600 to-purple-800',
    gengetone: 'from-purple-500 to-purple-700',
    shrap: 'from-purple-600 to-purple-800',
    singeli: 'from-pink-600 to-pink-800',
    'urban benga': 'from-pink-500 to-pink-700',
    'new benga': 'from-rose-500 to-rose-700',
    
    // North African genres - Earthy, warm tones
    'raï n\'b': 'from-amber-500 to-amber-700',
    'raï-hop': 'from-amber-600 to-amber-800',
    'gnawa fusion': 'from-orange-600 to-orange-800',
    
    // Fusion genres - Bold, mixed colors
    afrotrap: 'from-red-600 to-purple-600',
    'afro-gospel': 'from-blue-600 to-green-600',
    'urban gospel': 'from-indigo-600 to-blue-600',
    
    // Legacy fallbacks
    'hip-hop': 'from-red-500 to-red-700',
    'r-b': 'from-blue-500 to-blue-700',
    gospel: 'from-blue-600 to-blue-800',
    house: 'from-orange-500 to-orange-700',
