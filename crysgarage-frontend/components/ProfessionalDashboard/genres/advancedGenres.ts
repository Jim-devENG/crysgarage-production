...
export const ADVANCED_GENRES = {
  ...
  "CrysGarage": {
    gain: 0.0,
    compression: { threshold: 0, ratio: 1.0, attack: 0.0, release: 0.0 },
    eq: { low: 0.0, mid: 0.0, high: 0.0 },
    truePeak: 0.0,
    targetLufs: 0.0,
    description: "Flat Processing",
    color: "bg-gray-400"
  },
  "auto preset": {
    gain: 0.0,
...
export const getAdvancedGenreGradient = (genreId: string): string => {
  const colorMap: Record<string, string> = {
    ...
    "World": 'from-blue-500 to-blue-700',
    ...
    "CrysGarage": 'from-gray-400 to-gray-600',
    "auto preset": 'from-gray-400 to-gray-600'
  };
