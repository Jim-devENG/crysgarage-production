@echo off
echo 🚀 Comprehensive VPS Setup for Crys Garage
echo ==========================================
...
echo.
echo 📤 Uploading comprehensive setup script to VPS...
scp comprehensive_vps_setup.sh root@209.74.80.162:/var/www/crysgarage-deploy/

echo.
echo 🔧 Running comprehensive VPS setup...
echo This may take 10-15 minutes. Please be patient...
ssh root@209.74.80.162 "cd /var/www/crysgarage-deploy && chmod +x comprehensive_vps_setup.sh && ./comprehensive_vps_setup.sh"
